...
function Analytics() {
  ...
  useEffect(() => {
    const loadFiltersData = async () => {
      try {
        ...
        const templatesResponse = await apiService.get('/templates/public/all-for-analytics');
  ...
  }, [selectedLP, selectedProyectoGeneral, selectedUser, timeRange, includeAdmins, user]);
  ...
  const fetchMetrics = async () => {
    try {
      ...
      if (selectedProyectoGeneral) params.append("proyecto_general", selectedProyectoGeneral);
      ...
      const response = await apiService.get(`/logs/metrics?${params.toString()}`);
      setMetrics(response);
    } catch (err) {
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          />
          <p style={{ marginTop: "16px", color: "#6b7280" }}>Cargando usuario...</p>
        </div>
      </div>
    );
  }
      ...
      >
        <div style={{ textAlign: "center" }}>
          <RefreshCw
            ...
            style={{ color: "#3b82f6", animation: "spin 1s linear infinite" }}
          />
          <p style={{ marginTop: "16px", color: "#6b7280" }}>Cargando métricas...</p>
        </div>
      </div>
    );
  }
        ...
        >
          ...
          <div style={{ flex: "1", minWidth: "200px" }}>
            ...
            <select
              ...
              onChange={(e) => setTimeRange(e.target.value === "" ? null : Number(e.target.value))}
              style={{
                width: "100%",
                padding: "8px 12px",
                border: "1px solid #e5e7eb",
        ...
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          ...
          >
            ...
            <MetricCard
              ...
              value={metrics.avg_alignment_shift_score !== null && metrics.avg_alignment_shift_score !== undefined
          ...
          {metrics.alignment_trends && Object.keys(metrics.alignment_trends).length > 0 && (
            <div
              style={{
                backgroundColor: "white",
                padding: "24px",
            ...
            >
              ...
              <p style={{ fontSize: "14px", color: "#6b7280", marginBottom: "16px" }}>
                Muestra cómo mejora la IA con el tiempo (valores más altos = menos correcciones necesarias)
              </p>
              <ResponsiveContainer width="100%" height={300}>
                    ...
                    <tbody>
                      {metrics.user_activity.map((userStat, index) => (
                        <tr
                          ...
                          style={{
                            borderBottom: index < metrics.user_activity.length - 1 ? "1px solid #f3f4f6" : "none",
                        ...
                        >
                          ...
                          <td style={{ padding: "12px 8px", textAlign: "center", fontSize: "14px", color: "#111827", fontWeight: "600" }}>
                            {userStat.total_generations}
                          </td>
                          <td style={{ padding: "12px 8px", textAlign: "center", fontSize: "14px", color: "#10b981" }}>
                            {userStat.successful_generations}
                          </td>
                          <td style={{ padding: "12px 8px", textAlign: "center", fontSize: "14px", color: "#ef4444" }}>
                            {userStat.failed_generations}
                          </td>
                          <td style={{ padding: "12px 8px", textAlign: "center", fontSize: "14px", color: "#8b5cf6", fontWeight: "600" }}>
                            {userStat.total_edits}
                          </td>
                          <td style={{ padding: "12px 8px", textAlign: "center", fontSize: "14px", color: "#3b82f6" }}>
                          ...
                          <td style={{ padding: "12px 8px", textAlign: "center", fontSize: "14px", color: "#06b6d4" }}>
                            {userStat.avg_alignment_score !== null && userStat.avg_alignment_score !== undefined
                    ...
                    <div style={{ marginBottom: "16px" }}>
                      ...
                      >
                        ...
                        <span style={{ fontSize: "14px", fontWeight: "600", color: "#111827" }}>
                          {Math.round((metrics.user_profile.profile_confidence || 0) * 100)}%
                        </span>
                      </div>
                      <div
                        style={{
...
function MetricCard({ icon, title, value, color, subtitle }) {
  return (
    ...
    >
      ...
      <p style={{ fontSize: "32px", fontWeight: "bold", color: "#111827", margin: "8px 0" }}>
        {value}
      </p>
      {subtitle && (
