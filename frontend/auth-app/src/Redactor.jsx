              ...
              <button
                ...
                onMouseOver={(e) =>
                  (e.target.style.backgroundColor =
                    tableStyles.resetButtonHover.backgrounasdColor)
                }
                onMouseOut={(e) =>
                  (e.target.style.backgroundColor =
                    tableStyles.resetButton.backgroundColor)
                }
                    ...
                    const updateTableDataByBlock = (blockNumber, content) => {
                      ...
                      setTableData((prev) => {
                        ...
                        Object.entries(meta.contentMapping).forEach(
                          ([field, cellKey]) => {
                            if (
                              content.structured_content[field] !== undefined
                            ) {
                              updates[cellKey] = {
                                content: content.structured_content[field],
                              };
                            }
                          }
                        );
